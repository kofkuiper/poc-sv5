	...
	<main class="grid place-items-center pb-8 pt-16 md:pb-24 md:pt-12 lg:grid-cols-2">
		...
		<div>
			...
			<p class="mt-4 max-w-xl text-lg text-slate-600">
				Astroship is a starter template for startups, marketing websites &amp; landing pages.<wbr />
			...
			<div class="mt-6 flex flex-col gap-3 sm:flex-row">
				<a
					...
					target="_blank"
					rel="noopener"
					class="flex items-center justify-center gap-1 rounded border-2 border-transparent bg-black px-5 py-2.5 text-center text-white ring-gray-200 ring-offset-2 transition hover:bg-gray-800 focus-visible:ring-2"
				>
					<svg
						width="1em"
						height="1em"
					...
					>
						<symbol id="ai:bx:bxs-cloud-download"
							><path
								...
								fill="currentColor"
							></path></symbol
						><use xlink:href="#ai:bx:bxs-cloud-download"></use>
					</svg>
					Download for Free
				</a>
				<a
					...
					>
						<symbol id="ai:bx:bxl-github"
							><path
								...
								fill="currentColor"
							></path></symbol
						><use xlink:href="#ai:bx:bxl-github"></use>
					</svg>
					GitHub Repo
				</a>
			</div>
				...
				>
					<symbol id="ai:bx:bxs-file-find"
						><path
							...
							fill="currentColor"
						></path><circle cx="12" cy="14" r="3" fill="currentColor"></circle></symbol
		...
		<div class="mt-10 flex flex-wrap items-center justify-center gap-8 md:gap-20">
			...
			>
				<symbol id="ai:simple-icons:vercel"
					><path fill="currentColor" d="M24 22.525H0l12-21.05z"></path></symbol
				><use xlink:href="#ai:simple-icons:vercel"></use>
			</svg>
		</div>
	</div>
	<div
		class="mx-auto mt-20 flex max-w-5xl flex-col items-center rounded-lg bg-black p-8 text-center md:px-20 md:py-20"
	>
		...
		<div class="mt-5 flex">
			<a
				href="#"
				class="rounded border-2 border-transparent bg-white px-5 py-2.5 text-center text-black ring-gray-200 ring-offset-2 transition focus-visible:ring-2"
				>Get Started
			</a>
		</div>
	</div>
